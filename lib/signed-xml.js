...
SignedXml.prototype.validateSignatureValue = function() {
  ...
  // Updating signedInfoCanon to include additional namespace
  var signedInfoCanonUpdated = signedInfoCanon.replace('<SignedInfo xmlns="http://www.w3.org/2000/09/xmldsig#">', '<SignedInfo xmlns="http://www.w3.org/2000/09/xmldsig#" xmlns:saml2p="urn:oasis:names:tc:SAML:2.0:protocol">');
  var signer = this.findSignatureAlgorithm(this.signatureAlgorithm)
  var res = signer.verifySignature(signedInfoCanonUpdated, this.signingKey, this.signatureValue)
